# Npool basal middleware

[![Test](https://github.com/NpoolPlatform/basal-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/basal-middleware/actions/workflows/main.yml)
...
* make basal-middleware ```单独编译服务```
* make basal-middleware-image ```单独生成服务镜像```
